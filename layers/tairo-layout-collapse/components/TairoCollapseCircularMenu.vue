...
<template>
  <div
    class="after:bg-primary-600 after:shadow-primary-500/50  fixed end-[1em] top-[0.6em] z-[90] transition-transform duration-300 after:absolute after:right-0 after:top-0 after:block after:size-12 after:rounded-full after:shadow-lg after:transition-transform after:duration-300 after:content-['']"
    :class="[
      isOpened
  ...
  >
    <button
      type="button"
      class="bg-primary-500 shadow-primary-500/50 relative z-30 flex size-12 items-center justify-center rounded-full text-white shadow-lg"
